...
//go:generate gen-mysqlcrud -type DiscordBot
...
// DiscordBot record level dal model
type DiscordBot struct {
	ID int64 `db:"ID" ggAttr:"PK-Auto,-,-,-,-,-,-,-,GetBy" ggTable:"DiscordBot" ggDel:"None"`
	
	DiscordID sql.NullString `db:"DiscordID" ggAttr:"-,-,Null,-,-,Set-InsUpd,Check,Fill,-"`
