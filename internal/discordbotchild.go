...
//go:generate gen-mysqlcrud -type DiscordBotChild
...
// DiscordBotChild record level dal model
type DiscordBotChild struct {
	ID int64 `db:"ID" ggAttr:"PK-Auto,-,-,-,-,-,-,-,GetBy" ggTable:"DiscordBotChild" ggDel:"None"`

	DiscordBotID int64     `db:"DiscordBotID" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,GetBy"`
	ImageURL     string    `db:"ImageURL" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	TextContent  string     `db:"TextContent" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	Datetime     time.Time `db:"Datetime" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	AuthorDiscordID string     `db:"AuthorDiscordID" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	AuthorDiscordTag string     `db:"AuthorDiscordTag" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
