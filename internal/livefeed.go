...
//go:generate gen-mysqlcrud -type LiveFeed
...
// LiveFeed record level dal model
type LiveFeed struct {
	ID int64 `db:"ID" ggAttr:"PK-Auto,-,-,-,-,-,-,-,GetBy" ggTable:"LiveFeed" ggDel:"None"`

	UserID          int64  `db:"UserID" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,GetBy"`
	YouTubeLiveLink string `db:"YouTubeLiveLink" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
