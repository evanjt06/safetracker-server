...
//go:generate gen-mysqlcrud -type TwitterBot
...
// TwitterBot record level dal model
type TwitterBot struct {
	ID int64 `db:"ID" ggAttr:"PK-Auto,-,-,-,-,-,-,-,GetBy" ggTable:"TwitterBot" ggDel:"None"`
	
	TwitterID sql.NullString `db:"TwitterID" ggAttr:"-,-,Null,-,-,Set-InsUpd,Check,Fill,-"`
