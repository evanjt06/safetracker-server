...
//go:generate gen-mysqlcrud -type TwitterBotChild
...
// TwitterBotChild record level dal model
type TwitterBotChild struct {
	ID int64 `db:"ID" ggAttr:"PK-Auto,-,-,-,-,-,-,-,GetBy" ggTable:"TwitterBotChild" ggDel:"None"`

	TwitterBotID int64     `db:"TwitterBotID" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,GetBy"`
	...
	AuthorTwitterID string     `db:"AuthorTwitterID" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	AuthorTwitterTag string     `db:"AuthorTwitterTag" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
