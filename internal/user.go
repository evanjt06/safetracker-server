...
//go:generate gen-mysqlcrud -type User
...
// User record level dal model
type User struct {
	ID int64 `db:"ID" ggAttr:"PK-Auto,-,-,-,-,-,-,-,GetBy" ggTable:"User" ggDel:"None"`

	FirstName                 string `db:"FirstName" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	LastName                  string `db:"LastName" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	PhoneNumber               string `db:"PhoneNumber" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	EmailAddress              string `db:"EmailAddress" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,GetBy"`
	PointOfContact            string `db:"PointOfContact" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	PointOfContactPhoneNumber string `db:"PointOfContactPhoneNumber" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
	Password            string `db:"Password" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,GetBy,F=EmailAddress"`
	Location            string  `db:"Location" ggAttr:"-,-,-,-,-,Set-InsUpd,Check,Fill,-"`
